    ...
    if (querystring.length > 1) {
        ...
        for (i in pairs) {
            ...
            if (keyval[0] == "utm_content")
            {
                ...
                if(resultJson.utmcontent=="discovery" || resultJson.utmcontent=="Discovery" || resultJson.utmcontent=="Carousel-Ad_Discovery")
                {
                    document.getElementById('SocailSection').style.display="none";
